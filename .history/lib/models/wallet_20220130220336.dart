...
class Wallet {
  ...
  Wallet.fromJSON(Map<String, dynamic> json)
      : id = json[Field.data][Field.id],
        userId = json[Field.data][Field.userId],
        accountId = json[Field.data][Field.accountId],
        description = json[Field.data][Field.description],
        amount = json[Field.data][Field.amount];
}
