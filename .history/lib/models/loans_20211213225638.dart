class Loan {
  ...
  factory Loan.fromMap(Map<String, dynamic> map) {
    return Loan(
      ...
      appliedAmount: map['data']['applied_amount'] as String,
      totalPayable: map['data']['total_payable'] as String,
      totalPaid: map['data']['total_paid'] as String,
      latePaymentPenalty: map['data']['late_payment_penalties'] as String,
      attachment: map['data']['attachment'] as String,
      description: map['data']['updated_user_id'] as String,
