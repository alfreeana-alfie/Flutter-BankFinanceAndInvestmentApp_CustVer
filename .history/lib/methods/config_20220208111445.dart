...
class Method {
  //** ADD FUNCTION
  static void add(BuildContext context, Map<String, String> body, String url,
  ...
  // ** EDIT FUNCTION
  static void edit(
      BuildContext context, Map<String, String> body, String url,
      String routePath) async {
    ...
    if (response.statusCode == Status.ok) {
      ...
      CustomToast.showMsg(Status.successTxt, Styles.successColor);
      Future.delayed(const Duration(milliseconds: 2000), () {
        Navigator.pushReplacementNamed(context, RouteSTR.branchList);
      });
    } else {
