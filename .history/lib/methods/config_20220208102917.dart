...
class Method {
  static void add(BuildContext context, Map<String, String> body, String apiUrl, String routePath) async {
    final response = await http.post(
...
const charac = 'AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz';
