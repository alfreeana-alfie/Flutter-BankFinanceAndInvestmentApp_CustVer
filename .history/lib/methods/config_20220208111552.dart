...
class Method {
  //** ADD FUNCTION
  static void add(BuildContext context, RoundedLoadingButtonController controller, Map<String, String> body, String url,
  ...
  // ** EDIT FUNCTION
  static void edit(
      BuildContext context,RoundedLoadingButtonController controller, Map<String, String> body, String url,
      String routePath) async {
    // Uri url = Uri.parse(AdminAPI.updateBranch.toString() + id);
  ...
  // ** DELETE FUNCTION
  static void delete(BuildContext context,RoundedLoadingButtonController controller, String id) async {
    Uri url = Uri.parse(AdminAPI.deleteBranch.toString() + id);
