  ...
  static void addBytes(BuildContext context, Map<String, String> body,
    ...
    final request = http.MultipartRequest(Field.postMethod, API.loanRequest)
      ...
      ..files.addAll({
        ...
        http.MultipartFile.fromBytes(Field.nationalIdentityCard, listData02, filename: 'attachment.pdf'),
        http.MultipartFile.fromBytes(Field.bankStatement, listData03, filename: 'attachment.pdf')
      });
