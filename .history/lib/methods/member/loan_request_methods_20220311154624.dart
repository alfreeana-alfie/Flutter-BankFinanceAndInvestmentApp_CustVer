...
class LoanRequestMethods {
  static void add(
      BuildContext context, Map<String, String> body, String filename, String fileName02, String fileName03) async {
    final request = http.MultipartRequest(Field.postMethod, API.loanRequest)
      ...
      ..files.addAll({
        ...
        await http.MultipartFile.fromPath(Field.nationalIdentityCard, fileName02),
        await http.MultipartFile.fromPath(Field.bankStatement, filename)});
