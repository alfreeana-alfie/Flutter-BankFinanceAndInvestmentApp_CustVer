...
import 'package:flutter_banking_app/pages/admin/rate/rate_list.dart';
...
import 'pages/admin/transaction/wallet_transaction_list.dart';
  ...
  runApp(
    MaterialApp(
      ...
      home: SplashScreenView(
        navigateRoute: const WalletTransactionList(),
        duration: 4000,
        imageSize: 200,
      ...
      routes: {
        ...
        RouteSTR.walletList: (context) => const WalletTransactionList(),
