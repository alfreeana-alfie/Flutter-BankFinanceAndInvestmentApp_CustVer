...
class PeopleSlider extends StatefulWidget {
  const PeopleSlider({Key? key, this.toWhomId}) : super(key: key);
...
class _PeopleSliderState extends State<PeopleSlider> {
  ...
  void getList() async {
    final response = await http.get(API.listOfCulistrrency, headers: API.headers);
