...
class TransactionTodayListAccountant extends StatefulWidget {
  const TransactionTodayListAccountant({Key? key, this.userLoad}) : super(key: key);
...
class _TransactionTodayListAccountantState
  ...
  Future getCurrency() async {
    final response = await http.get(AdminAPI.listOfWalletTransactionsAccountant,
        headers: headers);
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int i) {
                ...
                return ListTile(
                  ...
                  title: Text(
                      transactionListNew[i].userName!.toUpperCase(),
