...
class Card1 extends StatelessWidget {
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(requests.description ?? Field.emptyString,
  ...
  Datetime createdAt = DateTime.parse(requests.createdAt)
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            ...
            DetailRow(labelTitle: Str.statusTxt, labelDetails: requests.status.toString()),
