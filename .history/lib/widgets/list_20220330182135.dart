                        ...
                        onPressed: () async {
                          ...
                          for (int i = 0;
                            ...
                            DateTime tempDate = DateTime.parse(
                                walletTransactionList[i].createdAt ??
                                    '2021-01-01');
                            String createdAt =
                            ...
                            row.cells[0].value =
                                walletTransactionList[i].userName;
                            row.cells[1].value =
                                walletTransactionList[i].currency;
                            row.cells[2].value =
                                walletTransactionList[i].amount;
                            row.cells[3].value =
                                walletTransactionList[i].rateAmount;
                            row.cells[4].value =
                                walletTransactionList[i].grandTotal;
                            row.cells[5].value =
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return Container(
            ...
            color: Styles.whiteColor,
            child: SfDateRangePicker(
              selectionMode: DateRangePickerSelectionMode.ra,
              showActionButtons: true,
              showTodayButton: true,
              onSelectionChanged: (DateRangePickerSelectionChangedArgs args) {
                if (args.value is PickerDateRange) {
