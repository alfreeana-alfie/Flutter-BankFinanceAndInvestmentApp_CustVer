...
class _SideDrawerState extends State<SideDrawer> {
  ...
  Widget build(BuildContext context) {
    return Drawer(child: userLoad.userType == 'admin' ? _adminMenu() : _accountant());
  }
        ...
        ListTile(
          ...
          title: Text(Str.dashboard,
              style: GoogleFonts.nunitoSans(
                  color: Styles.textColor.withOpacity(1))),
          onTap: () => {
            Navigator.pushReplacementNamed(context, RouteSTR.dashboardAccountant)
          },
        ),
        ExpansionTile(
          expandedCrossAxisAlignment: CrossAxisAlignment.stretch,
          leading: const Icon(Icons.transfer_within_a_station),
          title: Text(Str.customerList),
          children: [
            DrawerChild(
