        ...
        child: Column(
          children: [
            ...
            if(widget.type == Type.filterWalletTransaction) Container(
              ...
              headerTable.cells[2].value = Str.currency;
              headerTable.cells[3].value = Str.currency;
              headerTable.cells[4].value = Str.currency;
              headerTable.cells[5].value = Str.currency;
              headerTable.cells[6].value = Str.currency;
              //Add rows to the grid.
