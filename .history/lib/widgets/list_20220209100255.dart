...
class _CardListState extends State<CardList> {
  ...
  List<Branch> foundBranchList = [];
  List<Bank> foundBankList = [];
  List<Currency> foundCurrencyList = [];
  List<Question> found1uestionList = [];
  List<PlanFDR> foundFdrPlanList = [];
  List<GiftCard> foundGiftCardList = [];
  List<LoanProduct> founPdroductList = [];
  List<Navigation> foundNavigationList = [];
  List<NavigationItem> foundNavigationItemList = [];
  List<Transaction> foundTransactionList = [];
  List<Deposit> foundDepositList = [];
  List<WalletTransaction> foundWalletTransactionList = [];
  List<Permission> foundPermissionList = [];
  List<UserRole> foundoleList = [];
  List<Users> foundserList = [];
  List<Rate> foundateList = [];
  List<Service> founderviceList = [];
  List<Team> foundeamList = [];
  List<Testimonial> foundestimonialList = [];
