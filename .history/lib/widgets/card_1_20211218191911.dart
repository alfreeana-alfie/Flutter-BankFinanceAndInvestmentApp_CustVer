                    ...
                    header: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Gap(20),
                            Text(requests.createdAt ?? Field.emptyString,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            DetailRow(labelTitle: Str.createdTxt, labelDetails: requests.createdAt ?? Field.emptyString),
            DetailRow(labelTitle: Str.currencyTxt, labelDetails: requests.currencyName ?? Field.emptyString),
            DetailRow(labelTitle: Str.amountTxt, labelDetails: requests.amount ?? Field.emptyAmount),
            DetailRow(labelTitle: Str.statusTxt, labelDetails: requests.status ?? Field.emptyString),
            DetailRow(labelTitle: Str.descriptionTxt, labelDetails: requests.description ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.senderTxt,
                labelDetails: requests.senderId.toString(),),
            DetailRow(
                labelTitle: Str.receiverTxt,
                labelDetails: requests.receiverId.toString(),),
