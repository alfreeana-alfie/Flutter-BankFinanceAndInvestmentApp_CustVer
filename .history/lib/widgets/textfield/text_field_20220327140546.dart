...
// ?? START -- TEXT FIELD WITH INITIAL VALUES
...
// ?? END -- CUSTOM TEXT FIELD WITH INITIAL VALUES

// ?? START -- CUSTOM TEXT FORM FIELD
      ...
      return TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(7),
            borderSide: BorderSide(color: Colors.black12.withOpacity(0.05), width: 0.0),
          ),
          errorBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(7),
            borderSide: const BorderSide(color: Styles.dangerColor, width: 1.0),
          ),
          border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(7),
              borderSide: BorderSide.none,
