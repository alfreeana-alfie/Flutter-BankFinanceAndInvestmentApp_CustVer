...
class _CardListState extends State<CardList> {
  ...
  @override
  initState() {
    rootBundle.load('assets/images/logoTransparent.png')
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    grid.draw(
                        ...
                        bounds: const Rect.fromLTWH(10, 15, 0, 0));
                    ...
                    if (widget.startDate != null && widget.endDate != null) {
                      saveAndLaunchFile(bytes,
                        ...
                        widget.endDate == null) {
                      saveAndLaunchFile(bytes,
                        'daily_report_${widget.startDate}.pdf');
                    } else {
                      final m = DateFormat('yyyy');

                      saveAndLaunchFile(bytes,
                        'monthly_report_${monthName}_${m.format(DateTime.now()).toString()}.pdf');
                    }
                  },
          ...
          child: _foundUserList.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) => Card(
                      ...
                      margin: const EdgeInsets.symmetric(vertical: 10),
                      child: CardUser(
                        pageType: Type.branchStaff,
                        pageTitle: Str.staffList,
          ...
          child: _foundUserList.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) => Card(
                      ...
                      margin: const EdgeInsets.symmetric(vertical: 10),
                      child: CardUser(
                        pageType: Type.userList,
                        pageTitle: Str.usersList,
                        userLoad: userLoad,
                        users: _foundUserList[index],
                        userList: _foundUserList,
                        index: index,
          ...
          child: _foundUserList.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) => Card(
                      ...
                      margin: const EdgeInsets.symmetric(vertical: 10),
                      child: CardUser(
                        pageType: Type.accountant,
                        pageTitle: Str.accountantList,
                        userLoad: userLoad,
                        users: _foundUserList[index],
                        userList: _foundUserList,
                        index: index,
          ...
          child: _foundUserList.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) => Card(
                      ...
                      margin: const EdgeInsets.symmetric(vertical: 10),
                      child: CardUser(
                        pageType: Type.customerAdmin,
                        pageTitle: Str.customerList,
                        userLoad: userLoad,
                        users: _foundUserList[index],
                        userList: _foundUserList,
                        index: index,
          ...
          child: _foundUserList.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) => Card(
                      ...
                      margin: const EdgeInsets.symmetric(vertical: 10),
                      child: CardUser(
                        pageType: Type.accountManager,
                        pageTitle: Str.accountManagerList,
                        userLoad: userLoad,
                        users: _foundUserList[index],
                        userList: _foundUserList,
                        index: index,
