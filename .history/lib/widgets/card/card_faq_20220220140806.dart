...
import 'package:flutter_banking_app/pages/admin/faq_layout.dart';
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            DetailRow(labelTitle: Str.answer, labelDetails: question.answer ?? Field.emptyString),
            DetailRow(labelTitle: Str.locale, labelDetails: question.locale ?? Field.emptyString),
            DetailRow(labelTitle: Str.status, labelDetails: question.status.toString()),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Method.delete(
                                context,
                                Uri.parse(AdminAPI.deleteFaq.toString() + widget.faq!.id.toString()),
                                Type.faq,
                                FaqLayout(
                                  type: Field.create,
                                ),
