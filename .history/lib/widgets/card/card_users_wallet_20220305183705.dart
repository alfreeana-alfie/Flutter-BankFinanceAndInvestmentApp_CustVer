      ...
      children: [
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => UpdateWallet(
                    ...
                    type: userType == Field.accountManager ? const Gap(0) : Text(Str.edit.toUpperCase()),
                  ),
                ),
              );
            },
        ...
        Expanded(
          child: ElevatedButton(
            ...
            child: userType == Field.accountant
                ? Text(Str.deposit.toUpperCase())
                : userType == Field.accountManager ? const Gap(0) : Text(Str.edit.toUpperCase()),
            style: ElevatedButton.styleFrom(
                elevation: 0.0, primary: Styles.successColor),
          ),
        ),
