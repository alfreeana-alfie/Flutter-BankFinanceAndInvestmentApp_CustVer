      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            DetailRow(
                labelTitle: Str.name,
                labelDetails: team.name ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.image,
                labelDetails: team.image ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.role,
                labelDetails: team.role ?? Field.emptyString),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Method.delete(
                    context,
                    Uri.parse(AdminAPI.deleteTeam.toString() +
                        team.id.toString()),
                    Type.team,
                    TeamLayout(
                      type: Field.create,
