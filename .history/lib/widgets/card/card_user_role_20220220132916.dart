...
import 'package:flutter_banking_app/pages/admin/role_layout.dart';
import 'package:flutter_banking_app/pages/admin/users/role_layout.dart';
...
class CardUserRole extends StatelessWidget {
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(role.name ?? Field.emptyString,
  ...
  buildExpanded1(BuildContext context) {
    ...
    DateTime tempDate = DateTime.parse(role.createdAt ?? '-');
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            DetailRow(
                labelTitle: Str.description,
                labelDetails: role.description ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.created,
