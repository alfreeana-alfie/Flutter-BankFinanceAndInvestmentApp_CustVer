...
import 'package:flutter_banking_app/pages/admin/team/team_layout.dart';
...
class CardTeam extends StatelessWidget {
                    ...
                    header: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Gap(20),
                            Text(team.name ?? Field.emptyString,
  ...
  buildExpanded1(BuildContext context) {
    ...
    DateTime tempDate = DateTime.parse(team.createdAt ?? '-');
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            DetailRow(labelTitle: Str.name, labelDetails: team.name ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.image, labelDetails: team.image ?? Field.emptyString),
            DetailRow(labelTitle: Str.role, labelDetails: team.role ?? Field.emptyString),
