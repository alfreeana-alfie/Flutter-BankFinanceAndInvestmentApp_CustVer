      ...
      children: [
        Expanded(
          child: ElevatedButton(
            onPressed: () {
              Map<String, String> body = {Field.approved: 'approved'};

              Uri url = Uri.parse(
                  AdminAPI.updateWithdraw.toString() + withdraw.id.toString());

              WithdrawMethods.update(context, body, url,
                  Type.withdraw, RouteSTR.createWithdraw, Str.withdrawList);
        ...
        Expanded(
          child: ElevatedButton(
            onPressed: () {
              ...
              Map<String, String> body = {Field.approved: 'rejected'};
