                    ...
                    header: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Gap(20),
                            Text(users.memberId ?? Field.emptyString,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            ...
            DetailRow(
                labelTitle: Str.currentBalance, labelDetails: 'NGN ${double.parse(users.amount!).toStringAsFixed(2)}'),
        ...
        Expanded(
          child: ElevatedButton(
            ...
            child: userType == Field.accountant
                ? Text(
              Str.withdraw.toUpperCase() : Str.edit.toUpperCase(),
            ),
