      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            DetailRow(
                labelTitle: Str.name,
                labelDetails: bank.name ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.swiftCode,
                labelDetails: bank.swiftCode ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.bankCountry,
                labelDetails: bank.bankCountry ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.bankCurrency,
                labelDetails: bank.bankCurrency.toString()),
            DetailRow(
                labelTitle: Str.minTransferAmt,
                labelDetails: bank.minTransferAmt ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.maxTransferAmt,
                labelDetails: bank.maxTransferAmt ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.fixedCharge,
                labelDetails: bank.fixedCharge ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.chargeInPercentage,
                labelDetails: bank.chargeInPercentage ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.descriptions,
                labelDetails: bank.descriptions ?? Field.emptyString),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Method.delete(
                    context,
                    Uri.parse(AdminAPI.deleteOtherBank.toString() +
                        bank.id.toString()),
                    Type.otherBank,
                    OtherBankLayout(
                      type: Field.create,
                ...
                Future.delayed(const Duration(milliseconds: 1000), () {
                  OtherBankMethods.delete(context, bank.id.toString());
