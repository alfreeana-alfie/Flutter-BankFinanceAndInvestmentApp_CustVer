      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            ...
            DetailRow(labelTitle: Str.fee, labelDetails: deposit.fee ?? Field.emptyAmount),
            DetailRow(
                labelTitle: Str.grandTotal, labelDetails: grandTotal.toStringAsFixed(2)),
            ...
            DetailRow(labelTitle: Str.status, labelDetails: deposit.status ?? Field.emptyString),
            deposit.attachment == null ? deposit.assignTo == null
                ? _buildButtonRow(context)
                : DetailRow(
                    labelTitle: Str.assignedStaff,
                    labelDetails: deposit.assignTo ?? Field.emptyString) : DetailRow(labelTitle: Str.attachment, labelDetails: deposit.status ?? Field.emptyString),
          ],
        ),
      ]),
    );
