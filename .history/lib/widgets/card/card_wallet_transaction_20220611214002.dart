        ...
        Expanded(
          child: ElevatedButton(
            onPressed: () async {
              ...
              DateTime tempDate =
                  DateTime.parse(widget.transaction.createdAt ?? '2021-01-01');
              String createdAt = DateFormat(Styles.formatDate).format(tempDate);
              ...
              row.cells[1].value = widget.transaction.userName;
              row = grid.rows.add();
              row.cells[0].value = Str.currency;
              row.cells[1].value = widget.transaction.currency;
              row = grid.rows.add();
              row.cells[0].value = Str.amount;
              row.cells[1].value = widget.transaction.amount;
              row = grid.rows.add();
              row.cells[0].value = Str.rateAmount;
              row.cells[1].value = widget.transaction.rateAmount;
              row = grid.rows.add();
              row.cells[0].value = Str.grandTotal;
              row.cells[1].value = widget.transaction.grandTotal;
              row = grid.rows.add();
              row.cells[0].value = Str.method;
              row.cells[1].value = widget.transaction.paymentMethod;
              row = grid.rows.add();
              ...
              saveAndLaunchFile(bytes, '${widget.transaction.transactionCode}.pdf');
            },
            child: Text(
