      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            DetailRow(
                labelTitle: Str.name,
                labelDetails: branch.name ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.contactEmail,
                labelDetails: branch.contactEmail ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.contactPhone,
                labelDetails: branch.contactPhone ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.address,
                labelDetails: branch.address ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.descriptions,
                labelDetails: branch.descriptions ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.totalStaff,
                labelDetails: branchList.length.toString()),
...
class _CardBranchState extends State<CardBranch> {
  ...
  void getUserList(id) async {
    Uri viewSingleUser = Uri.parse(API.listofStaff.toString() + id);
                    ...
                    header: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Gap(20),
                            Text(
                              widget.branch.name ?? Field.emptyString,
                              style: Theme.of(context).textTheme.headline6,
                              overflow: TextOverflow.ellipsis,
                            ),
                          ],
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            DetailRow(
                labelTitle: Str.name,
                labelDetails: widget.branch.name ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.contactEmail,
                labelDetails: widget.branch.contactEmail ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.contactPhone,
                labelDetails: widget.branch.contactPhone ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.address,
                labelDetails: widget.branch.address ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.descriptions,
