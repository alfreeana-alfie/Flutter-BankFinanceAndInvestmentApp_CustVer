        ...
        Column(
          ...
          children: [
            DetailRow(
                ...
                labelDetails: loan.id.toString(), ?? Field.emptyString),
            DetailRow(
      ...
      children: [
        Expanded(
          child: RoundedLoadingButton(
            ...
            onPressed: () {
              print(loan.id.toString());
              Map<String, String> body = {'status': '2'};
              Method.edit(
                  context,
                  _btnController,
                  body,
                  Uri.parse(AdminAPI.updateLoanRequest.toString() +
                      loan.id.toString()),
                  Type.loan,
        ...
        Expanded(
          child: RoundedLoadingButton(
            ...
            controller: _btnController,
            onPressed: () {
              Map<String, String> body = {'status': '3'};
              Method.edit(
                  context,
                  _btnController,
                  body,
