...
class CardUsedGiftCard extends StatelessWidget {
  const CardUsedGiftCard({Key? key, required this.currency}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            DetailRow(labelTitle: Str.name, labelDetails: currency.name ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.exchangeRate, labelDetails: currency.exchangeRate ?? Field.emptyString),
            DetailRow(labelTitle: Str.baseCurrency, labelDetails: currency.baseCurrency.toString()),
            DetailRow(labelTitle: Str.status, labelDetails: currency.status.toString()),
