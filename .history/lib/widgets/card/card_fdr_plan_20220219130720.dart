...
import 'package:flutter_banking_app/pages/admin/fdr/fdr_plan_layout.dart';
                    ...
                    header: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Gap(20),
                            Text(plan.name ?? Field.emptyString,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            ...
            DetailRow(
                labelTitle: Str.duration,
                labelDetails: plan.duration.toString()),
            DetailRow(
                labelTitle: Str.durationType,
