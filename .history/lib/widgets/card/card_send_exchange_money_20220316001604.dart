...
class CardSendExchangeMoney extends StatelessWidget {
  const CardSendExchangeMoney({Key? key, required this.deposit}) : super(key: key);
                    ...
                    header: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Gap(20),
                            Text(deposit.transactionCode ?? Field.emptyString,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          ...
          children: [
            ...
            DetailRow(labelTitle: Str.fee, labelDetails: deposit.fee ?? Field.emptyString),
            // DetailRow(labelTitle: Str.drCr, labelDetails: deposit.drCr ?? Field.emptyString),
            DetailRow(labelTitle: Str.bank, labelDetails: deposit.bank ?? Field.emptyString),
            DetailRow(labelTitle: Str.accountNo, labelDetails: deposit.accountno ?? Field.emptyString),
