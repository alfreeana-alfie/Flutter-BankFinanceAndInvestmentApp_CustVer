...
class CardUserWallet extends StatelessWidget {
  const CardUserWallet({Key? key, required this.users, required this.userList, required this.index}) : super(key: key);
                    ...
                    header: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Gap(20),
                            Text(users.userName ?? Field.emptyString,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            DetailRow(labelTitle: Str.name, labelDetails: users.userName ?? Field.emptyString),
            DetailRow(labelTitle: Str.phoneNumber, labelDetails: users.userPhone ?? Field.emptyString),
            DetailRow(labelTitle: Str.amount, labelDetails: users.amount ?? Field.emptyString),
