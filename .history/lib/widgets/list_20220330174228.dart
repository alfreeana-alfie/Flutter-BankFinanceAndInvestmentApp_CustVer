...
import 'package:flutter_banking_app/methods/pdf_lib/mobile.dart' if (dart.library.html) 'package:flutter_banking_app/methods/pdf_lib/web.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            const Gap(10),
            if(widget.type == Type.filterWalletTransaction) Container(
              ...
              DateTime tempDate =
                  DateTime.parse(walletTransactionList[i].createdAt ?? '2021-01-01');
              ...
              row.cells[2].value = walletTransactionList[i].currency;
              row.cells[3].value = walletTransactionList[i].currency;
              row.cells[4].value = walletTransactionList[i].currency;
              row.cells[5].value = walletTransactionList[i].currency;
              row.cells[6].value = walletTransactionList[i].currency;
              // row = grid.rows.add();
