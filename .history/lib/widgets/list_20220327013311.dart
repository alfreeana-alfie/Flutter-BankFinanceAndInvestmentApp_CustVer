            ...
            Row(
              children: [
                Expanded(
                  flex: 5,
                  child: Padding(
                    padding: widget.startDate != null ? const EdgeInsets.fromLTRB(
                        Values.horizontalValue * 2, 0, 0, 0) : const EdgeInsets.fromLTRB(
                        Values.horizontalValue * 2, 0, Values.horizontalValue * 2, 0),
                    child: TextFormField(
                ...
                if (widget.type == Type.filterWalletTransaction)
                  widget.startDate != null
                      ...
                      : const Padding(padding: EdgeInsets.fromLTRB(0, 0, Values.horizontalValue*2, 0),),
              ],
            ),
            _card(),
          ],
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => CardList(
                      ...
                      endDate: f.format(endDate!).toString(),
                      // path: BranchLayout(
                      //   type: Field.create,
                      // ),
                    ),
