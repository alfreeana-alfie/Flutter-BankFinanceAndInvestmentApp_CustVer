...
const Color primaryColor = Color(00xFF161D28);
const Color textColor = Color(0xff000000);
const Color greenFirstColor = Color(0xffA8DE1C);
const Color greenSecondColor = Color(0xff50AC02);
const Color orangeFirstColor = Color(0xffFC9000);
