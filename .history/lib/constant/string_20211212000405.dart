...
String contactNoText = "Phone No";
String birthDateText = "Date of Birth";
String genderText = "Gender";
String addr1Text = "Address Line 1";
String addr2Text = "Address Line 2";
String postcodeText = "Postcode";
String divisionText = "Division";
String districtText = "District";
String stateText = "State";
String icPassportText = "NRIC No/Passport";
String bankNameText = "Bank Name";
String bankAccNoText = "Bank Account No";
...
String addr1HintText = "House No/ Unit No";
String addr2HintText = "Stree Name/ Building Name";
String postcodeHintText = "Postcode (Eg: 96000)";
String divisionHintText = "Division (Eg: Sibu)";
String districtHintText = "District (Eg: Selangau)";
String stateHintText = "State (Eg: Sarawak)";
...
String homepageText = 'Home';
String aboutUsText = 'About Us';
String ourServicesText = 'Our Services';
String faqText = 'FAQ';
...
class Str {
  ...
  static String viewDetailsTxt = 'View Detail(s)';
  static String newRequestTxt = 'New Payment Request';
  static String receiverAccountTxt = 'Receiver Account';
  ...
  static String createdTxt = 'Created';
  static String senderTxt = 'Sender';
  static String receiverTxt = 'Receiver';

  static String balanceTxt = 'Balance(s)';
  static String addNewCardTxt = 'Add New Balance';

  static String loanIdTxt = 'Loan ID';
  static String loanProductTxt = 'Loan Product';
  static String appliedAmountTxt = 'Applied Amount';
  static String totalPayableTxt = 'Total Payable';
  static String amountPaidTxt = 'Amount Paid';
  static String dueAmountTxt = 'Due Amount';
  static String releaseDateTxt = 'Release Date';
  static String myLoanTxt = 'My Loan(s)';
  static String applyLoanTxt = 'Apply New Loan';
  static String firstPaymentDateTxt = 'First Payment Date';
  static String remarkTxt = 'Remarks';
  static String attachmentTxt = 'Attachment';
  static String browseTxt = 'Browse';
  static String fdrHistoryTxt = 'FDR History';
  static String depositPlanTxt = 'Deposit Plan';
  static String depositAmountTxt = 'Deposit Amount';
  static String returnAmountTxt = 'Return Amount';
  static String matureDateTxt = 'Mature Date';
  static String createTicketTxt = 'Create New Ticket';
  static String subjectTxt = 'Subject';Create New Ticket';
  static String createTicketTxt = 'Create New Ticket';
