...
class Values {
  static String logoPath = 'assets/images/logoTransparent.png';
  ...
  static String stripeLogoPath = 'assets/images/Stripe_Logo_02.png';
  static String billplzLogoPath = 'assets/images/Stripe_Logo_02.png';
