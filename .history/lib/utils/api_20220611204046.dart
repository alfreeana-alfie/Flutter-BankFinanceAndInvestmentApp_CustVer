...
// Header Settings
const Map<String, String> headers = {"Access-Control-Allow-Origin: *"'Accept': 'application/json'};
...
class API {
  ...
  static Uri updateProfile = Uri.parse('$android/update_single_user/');
  ...
  static Uri listofStaffByBranches = Uri.parse('$android/staff_by_branches/');
  ...
  static Uri createWithdraw = Uri.parse('$android/create_withdraw_request');
  static Uri withdrawList = Uri.parse('$android/get_user_withdraw_list/');
}

class AdminAPI {

  static Uri listOfLoanRequest                  = Uri.parse('$android/list_of_loan_request');
  static Uri updateLoanRequest                  = Uri.parse('$android/update_loan/');
    // Account
  ...
  static Uri updateWithdraw                     = Uri.parse('$android/update_approval/');

  static Uri showSavings                        = Uri.parse('$android/user_savings');

    // Rate
  static Uri listOfRate                         = Uri.parse('$android/rate_list');
  static Uri listOfWithdraw                     = Uri.parse('$android/get_list_of_withdraws');
  // static Uri createDeposit                   = Uri.parse('$android/create_deposit');
  ...
  static Uri deleteUser                         = Uri.parse('$android/deleted/');
  ...
  static Uri listOfFilterWalletTransactions           = Uri.parse('$android/filter_wallet_transactions_list/');
  static Uri listOfFilterWalletTransactionsByMonth    = Uri.parse('$android/filter_wallet_transactions_list_by_month/');
  static Uri listOfFilterSingleDateWalletTransactions = Uri.parse('$android/filter_wallet_transactions_list/');
  static Uri listOfWalletTransactionsAccountant       = Uri.parse('$android/accountant_transaction_list/');
  ...
  static Uri listOfCustomer                     = Uri.parse('$android/customer_a');
  static Uri listOfAdmin                        = Uri.parse('$android/admin');
  static Uri listOfAccountant                   = Uri.parse('$android/accountant');
  // static Uri listOfAmbassador                = Uri.parse('$android/ambassador');
  static Uri listOfAccountManager               = Uri.parse('$android/account_management');
