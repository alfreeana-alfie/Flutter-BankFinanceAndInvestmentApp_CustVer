class Str {
  ...
  static String rateTxt = 'Rate';
  static String rateAmountTxt = 'Rate Amount';
  static String grandTotalTxt = 'Grand Total';Rate';
  ...
  static String functionNameTxt = 'Function Name';
  ...
  static String fdrPackagesTxt = 'FDR Packages';
  static String loanListTxt = 'Loan List';
  ...
  static String rateListTxt = 'Rate List';
  ...
  static String subcribeNowTxt = 'Subcribe Now';
  static String currentRateTxt = 'Current Rate';
}
