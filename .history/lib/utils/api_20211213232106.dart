...
class API {
  ...
  static Uri listOfPaymentRequest = Uri.parse('http://127.0.0.1:8000/api/list_of_wire_transfer');
  
  static Uri loanRequest = Uri.parse('http://127.0.0.1:8000/api/loan_request'); // NOT WORKING

  static Uri fixedDeposit = Uri.parse('http://127.0.0.1:8000/api/fixed_deposit'); // NOT WORKING
}
