...
class Type {
  ...
  static String deposit = 'deposit';
  static String faq = 'faq';
  static String fdr = 'fdr';
  static String giftCard = 'gift_card';
  static String loanManagement = 'loan_management';
  static String navigation = 'navigation';
  static String otherBank = 'other_bank';
  static String rate = 'rate';
  static String service = 'service';
  static String team = 'team';
  static String testimonial = 'testimonial';
  static String ticket = 'ticket';
  static String exchanceMoney = 'exchange_money';
  static String sendMoney = 'send_money';
  static String wireTransfer = 'wire_transfer';
  static String userPermission = 'user_permission';
