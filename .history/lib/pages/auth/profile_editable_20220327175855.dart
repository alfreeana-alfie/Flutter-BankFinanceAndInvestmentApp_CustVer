    ...
    Widget fileDetails(PlatformFile file) {
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            CircleAvatar(
              // backgroundImage: FileImage(File(file.path!)) != null ? MemoryImage(fileBytes!) : MemoryImage(fileBytes!),
              backgroundImage: MemoryImage(fileBytes!),
              minRadius: 10,
              maxRadius: 50,
            ),
            if(file.path != null) CircleAvatar(
                        ...
                        onPressed: () {
                          if (file?.name == null) {
                            ...
                            updateProfile(
                                ...
                                _btnController,
                                body,
                                file!.path ?? Values.userDefaultImage,
                                // API.updateProfile,
                                Field.profilePicture,
                                // Field.putMethod,
                                widget.user.id.toString());
