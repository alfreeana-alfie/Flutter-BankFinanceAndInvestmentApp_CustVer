...
class _ProfileSettingsState extends State<ProfileSettings> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: myAppBar(
          title: Str.newRequest, implyLeading: true, context: context),
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: Str.receiverAccount,
                          labelStyle: Styles.subtitleStyle,
                          hintText: Str.receiverAccount,
                      ...
                      TextFormField(
                        ...
                        maxLines: 1,
                        decoration: InputDecoration(
                          labelText: Str.amount,
                          labelStyle: Styles.subtitleStyle,
                          hintText: Str.amountNum,
                          hintStyle: Styles.subtitleStyle03,
                          border: const OutlineInputBorder(
                            borderSide: BorderSide.none,
                            gapPadding: 0.0,
