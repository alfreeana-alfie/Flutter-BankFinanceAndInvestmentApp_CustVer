                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      elevatedButton(
                        ...
                        context: context,
                        callback: () {
                          var split1 = widget.user.profilePicture.split(pattern)
                          Map<String, String> body = {
                            Field.name: name ?? Field.emptyString,
                            Field.profilePicture: file?.name ??widget.user.profilePicture ??Values.userDefaultImage,
                            Field.countryCode: countryCode ?? Field.emptyString,
                            Field.phone: phone ?? Field.emptyString,
                            // Field.userType: widget.user.userType ?? Field.emptyString,
                            // Field.roleId: widget.user.roleId ?? Field.emptyInt,
                            // Field.branchId: widget.user.branchId ?? Field.emptyInt,
                            // Field.status: status.toString(),
                            // Field.email: email ?? Field.emptyString,
                            // Field.password: widget.user.password ?? Field.emptyString,
                            // Field.provider: provider ?? Field.emptyString,
                            // Field.providerId: providerId ?? Field.emptyInt,
                          };
                        },
                        text: Str.save.toUpperCase(),
                      ),
                    ],
                  ),
                ),
