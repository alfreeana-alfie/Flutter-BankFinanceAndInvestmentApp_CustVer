...
import 'package:flutter_banking_app/pages/account_manager/dashboard.dart';
import 'package:flutter_banking_app/pages/accountant/dashboard.dart';
        ...
        switch (user.userType) {
          ...
          case 'account_manager':
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const AccountManagementDashboard(),
                ));
            break;
          ...
          Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const SignInPg(),
                ));
        }
      }
    } catch (e) {
