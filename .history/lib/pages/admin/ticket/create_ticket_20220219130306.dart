...
class SupportTicketLayout extends StatefulWidget {
  const SupportTicketLayout({Key? key, this.type}) : super(key: key);
...
class _CreateSupportTicketState extends State<SupportTicketLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:
          myAppBar(title: Str.createSupportTicket, implyLeading: true, context: context),
      body: ListView(
