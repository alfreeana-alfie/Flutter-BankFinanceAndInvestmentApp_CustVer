...
class UpdateTeam extends StatefulWidget {
  const UpdateTeam({Key? key, this.team, this.type}) : super(key: key);
...
class _UpdateTeamState extends State<UpdateTeam> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: myAppBar(
          title: widget.type == Field.update ? Str.updateTeam : Str.createTeam, implyLeading: true, context: context),
      body: ListView(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  NewField(
                      mandatory: true,
                      initialValue: widget.type == Field.update ? widget.team?.name : Field.empty,
                  ...
                  NewField(
                      mandatory: true,
                      initialValue: widget.type == Field.update ? widget.team?.role: Field.empty,
                      ...
                      onPressed: () {
                        ...
                        widget.type == Field.update
                            ? Method.edit(
                                ...
                                _btnController,
                                body,
                                Uri.parse(AdminAPI.updateBranch.toString() + widget.team!.id.toString()),
                                Type.team,
                                BranchLayout(
                                  type: Field.create,
                                ),
