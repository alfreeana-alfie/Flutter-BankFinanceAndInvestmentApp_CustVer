...
class DepositLayout extends StatefulWidget {
  const DepositLayout({Key? key, required this.deposit, required this.notUsed})
      : super(key: key);
  ...
  @override
  _DepositLayoutState createState() => _DepositLayoutState();
}

class _DepositLayoutState extends State<DepositLayout> {
                    ...
                    child: elevatedButton(
                      ...
                      callback: () {
                        Map<String, String> body = {
                          ...
                          Field.currencyId:
                              currency ?? widget.deposit.currencyId.toString(),
                          Field.amount: amount ??
                          ...
                          Field.drCr:
                              drCr ?? widget.deposit.drCr ?? Field.emptyString,
                          Field.type:
                              type ?? widget.deposit.type ?? Field.emptyAmount,
                          Field.method: method ??
                              widget.deposit.method ??
                              Field.emptyAmount,
                          Field.status: status.toString(),
                          Field.note:
                              note ?? widget.deposit.note ?? Field.emptyAmount,
                          Field.loanId:
                              loanId ?? widget.deposit.loanId.toString(),
                          Field.refId: refId ?? widget.deposit.refId.toString(),
                          Field.parentId:
                              parentId ?? widget.deposit.parentId.toString(),
                          Field.otherBankId: otherBankId ??
                              widget.deposit.otherBankId.toString(),
                          Field.gatewayId:
                              gatewayId ?? widget.deposit.gatewayId.toString(),
                          Field.createdUserId:
                              userId ?? widget.deposit.userId.toString(),
                          Field.updatedUserId:
                              userId ?? widget.deposit.userId.toString(),
                          Field.branchId:
                              branchId ?? widget.deposit.branchId.toString(),
