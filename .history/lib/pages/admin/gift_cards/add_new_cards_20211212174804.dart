...
class AddNewGiftCard extends StatefulWidget {
  const AddNewGiftCard({Key? key}) : super(key: key);

  @override
  _AddNewGiftCardState createState() => _AddNewGiftCardState();
}

class _AddNewGiftCardState extends State<AddNewGiftCard> {
