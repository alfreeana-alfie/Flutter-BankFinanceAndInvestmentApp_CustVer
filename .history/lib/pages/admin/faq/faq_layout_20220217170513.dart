...
class UpdateFaq extends StatefulWidget {
  const UpdateFaq({Key? key, required this.faq, this.type}) : super(key: key);
...
class _UpdateFaqState extends State<UpdateFaq> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:
          myAppBar(title: widget.type == Field.update ? Str.updateFaq : Str.createFaq, implyLeading: true, context: context),
      body: ListView(
