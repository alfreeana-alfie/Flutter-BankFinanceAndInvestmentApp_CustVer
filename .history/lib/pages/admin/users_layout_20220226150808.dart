...
class UsersLayout extends StatefulWidget {
  const UsersLayout({Key? key, this.user, this.type, this.userType,
      this.creatorType}) : super(key: key);
                      ...
                      onPressed: () {
                        ...
                        widget.type == Field.update
                            ...
                            : Method.addFile(
                                ...
                                Str.customerList, Field.profilePicture) : widget.type == Field.update
                            ? Method.edit(
                                context,
                                _btnController,
                                body,
                            ...
                            : Method.addFile(
                                ...
                                Str.customerList, Field.profilePicture);;
                      },
