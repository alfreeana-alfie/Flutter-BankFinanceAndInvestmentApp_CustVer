            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ToggleSwitch(
                    initialLabelIndex: int.parse(widget.navigationItem?.status ?? Field.empty),
                    minWidth: 120,
                    cornerRadius: 7.0,
                  ...
                  Container(
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: () {
                        status ??= int.parse(widget.navigationItem?.status ?? Field.emptyAmount,);
                        Map<String, String> body = {
                          Field.navigationId: navigation ??
                              widget.navigationItem?.navigationId.toString() ?? Field.emptyAmount,
                          Field.type: type ??
                              widget.navigationItem?.type ??
                              Field.emptyInt,
                          Field.pageId: Field.emptyAmount,
                          Field.url:
                          ...
                          Field.target: target ??
                              ...
                              Field.emptyInt,
                          Field.parentId: Field.emptyAmount,
                          Field.position: Field.emptyAmount,
                        ...
                        widget.type == Field.update
                            ? Method.edit(
                                ...
                                _btnController,
                                body,
                                Uri.parse(AdminAPI.updateNavigationItem.toString() + widget.navigationI!.id.toString()),
                                Type.branch,
                                BranchLayout(
                                  type: Field.create,
                                ),
