                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: () {
                        Map<String, String> body = {
                          Field.navigationId: navigation ?? Field.emptyInt,
                          Field.type: type ?? Field.emptyInt,
                          Field.pageId: Status.pending.toString(),
                          Field.url: url ?? Field.emptyInt,
                          Field.icon: Status.pending.toString(),
                          Field.target: target ?? Field.emptyInt,
