...
class GiftCardLayout extends StatefulWidget {
  const GiftCardLayout({Key? key, required this.giftCard}) : super(key: key);

  final GiftCard giftCard;

  @override
  _UpdateGiftCardState createState() => _UpdateGiftCardState();
}

class _UpdateGiftCardState extends State<UpdateGiftCard> {
