            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update ? widget.giftCard?.code : Field.empty,
                  ...
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update ? widget.giftCard?.amount : Field.empty,
                  ...
                  ToggleSwitch(
                    initialLabelIndex: int.parse(widget.giftCard?.status ?? Field.emptyAmount),
                    minWidth: 120,
                    cornerRadius: 7.0,
                  ...
                  Container(
                    ...
                    child: elevatedButton(
                      ...
                      context: context,
                      callback: () {
                        status ??= int.parse(widget.giftCard?.status ?? Field.emptyAmount);
                        Map<String, String> body = {
                          Field.code: code ??
                              widget.giftCard?.code ??
                              Field.emptyString,
                          Field.currencyId: currency ??
                              widget.giftCard?.currencyId.toString() ?? Field.emptyAmount,
                          Field.amount: amount ??
                              widget.giftCard?.amount ??
                              Field.emptyAmount,
                          Field.status: status.toString(),
                          Field.userId: userId ?? widget.giftCard?.userId.toString() ?? Field.emptyAmount,
                          Field.branchId: branchId ?? widget.giftCard?.userId.toString() ?? Field.emptyAmount,
                          // Field.usedAt: user,
                        };

                        GiftCardMethods.edit(context, body, widget.giftCard?.id.toString() ?? Field.emptyAmount);
                      },
                      text: Str.submit,
                    ),
                  ),
