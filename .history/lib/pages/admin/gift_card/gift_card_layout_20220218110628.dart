            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ToggleSwitch(
                    initialLabelIndex:
                        int.parse(widget.giftCard?.status ?? Field.emptyAmount),
                    minWidth: 120,
                    cornerRadius: 7.0,
                  ...
                  Container(
                    ...
                    child: elevatedButton(
                      ...
                      callback: () {
                        status ??= int.parse(
                            widget.giftCard?.status ?? Field.emptyAmount);
                        ...
                        widget.type == Field.update
                            ? Method.edit(
                                ...
                                _btnController,
                                body,
                                Uri.parse(AdminAPI.updateBranch.toString() + widget.giftCard!.id.toString()),
                                Type.giftCard,
                                GiftCardLayout(
                                  type: Field.create,
                                ),
