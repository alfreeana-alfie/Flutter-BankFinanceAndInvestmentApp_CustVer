...
class UsersLayout extends StatefulWidget {
  const UsersLayout({Key? key, this.user, this.type}) : super(key: key);
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ToggleSwitch(
                    initialLabelIndex: int.parse(widget.user?.status.toString() ?? Field.empty),
                    minWidth: 120,
                    cornerRadius: 7.0,
                  ...
                  Container(
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: () {
                        status ??= int.parse(widget.user?.status.toString() ?? Field.emptyInt);
