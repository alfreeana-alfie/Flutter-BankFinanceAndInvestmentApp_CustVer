...
class CreateUsers extends StatefulWidget {
  const CreateUsers({Key? key, this.user, this.type}) : super(key: key);
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update ? widget.user?.name : Field.empty,
                  ...
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update ? widget.user?.email : Field.empty,
                  ...
                  NewField(
                    mandatory: true,
                    obsecure: true,
                    initialValue: widget.type == Field.update ? widget.user?.password : Field.empty,
                  ...
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update ? widget.user?.provider : Field.empty,
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: CountryCodePicker(
                            ...
                            onInit: (value) {
                              countryCode = widget.type == Field.update ? widget.user?.countryCode : value.toString();
                            },
                      ...
                      Expanded(
                        child: TextFieldCustom(
                          initialValue: widget.type == Field.update ? widget.user?.phone : Field.empty,
                  ...
                  const Gap(20),
                  widget.type == Field.update ? const Gap(1) : Container(
