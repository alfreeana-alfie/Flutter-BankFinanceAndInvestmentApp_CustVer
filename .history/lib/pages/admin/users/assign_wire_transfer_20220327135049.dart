...
class AssignWireTransfer extends StatefulWidget {
  const AssignWireTransfer({Key? key, this.transactionId, this.transactionCode}) : super(key: key);

  final String? transactionId, transactionCode;
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: () {
                        ...
                        emailMessage =
                            '';
                        emailMessage01 =
                            'Please check your account for new task. You have newly assigned wire transfer transaction as below, ';
                        emailMessage02 =
                            'Transaction Code: ${widget.transactionCode} ';
                        emailMessage03 =
                            '';

                        EmailJS.send(
                            context,
                            usersEmail ?? 'customer@gmail.com',
                            usersName ?? 'user',
                            'FVIS Investment',
