            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  NewField(
                      mandatory: true,
                      initialValue:  widget.type == Field.update ? widget.bank?.swiftCode,
                      onSaved: (val) => swiftCode = val,
                      hintText: Str.swiftCode),
                  const Gap(20.0),
                  NewField(
                      mandatory: true,
                      initialValue: widget.bank?.bank?Country,
                      onSaved: (val) => bank?Country = val,
                      hintText: Str.bank?Country),
                  const Gap(20.0),
                  NewField(
                      mandatory: true,
                      initialValue: widget.bank?.bank?Currency.toString(),
                      onSaved: (val) => bank?Currency = val,
                      hintText: Str.bank?Currency),
                  const Gap(20.0),
                  NewField(
                    mandatory: true,
                    ...
                    child: elevatedButton(
                      ...
                      callback: () {
                        ...
                        Map<String, String> body = {
                          ...
                          Field.bank?Country: bank?Country ?? widget.bank?.bank?Country ?? Field.emptyString,
                          Field.bank?Currency:
                              bank?Currency ?? widget.bank?.bank?Currency.toString(),
