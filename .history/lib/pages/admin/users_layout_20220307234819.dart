...
class UsersLayout extends StatefulWidget {
  const UsersLayout(
      {Key? key, this.user, this.type, this.userType, this.creatorType, this.userLoad})
      : super(key: key);

  final Users? user, userLoad;
  final String? type;
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: () {
                        ...
                        Map<String, String> body = {
                          ...
                          Field.userType:
                              userType ?? widget.userType ?? Field.emptyString,
                        ...
                        widget.creatorType != Field.admin
                          ...
                          CustomToast.showMsg(Str.invalidConfirmPassword, Styles.dangerColor);
                        }
                      },
