...
class WithdrawGateway extends StatefulWidget {
  const WithdrawGateway({Key? key}) : super(key: key);

  @override
  _WithdrawGatewayState createState() => _WithdrawGatewayState();
}

class _WithdrawGatewayState extends State<WithdrawGateway> {
