...
class WithdrawMethods extends StatefulWidget {
  const WithdrawMethods({Key? key}) : super(key: key);

  @override
  _WithdrawMethodsState createState() => _WithdrawMethodsState();
}

class _WithdrawMethodsState extends State<WithdrawMethods> {
