                      ...
                      child: elevatedButton(
                        ...
                        callback: () {
                          Map<String, String> body = {
                            ...
                            Field.currentRate: currentRate ?? widget.rate.currentRate ?? Field.currentRate,
                            Field.status: status.toString(),
                          };

                          RateMethods.edit(context, body, widget.rate.id.toString());
                        },
