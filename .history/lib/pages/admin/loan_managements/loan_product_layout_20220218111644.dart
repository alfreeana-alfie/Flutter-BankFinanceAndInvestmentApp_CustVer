            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update ? widget.loanProduct?.interestType : Field.empty,
                  ...
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update ? widget.loanProduct?.term.toString() : Field.empty,
                  ...
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update ? widget.loanProduct?.termPeriod : Field.empty,
                  ...
                  ToggleSwitch(
                    initialLabelIndex: int.parse(widget.loanProduct?.status ?? Field.emptyAmount),
                    minWidth: 120,
                    cornerRadius: 7.0,
                  ...
                  Container(
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: () {
                        status ??= int.parse(widget.loanProduct?.status ?? Field.emptyAmount);
                        Map<String, String> body = {
                          ...
                          Field.interestType: interestType ??
                              ...
                              Field.emptyString,
                          Field.term:
                              term ?? widget.loanProduct?.term.toString() ?? Field.emptyAmount,
                        ...
                        //     context, body, widget.loanProduct?.id.toString() ?? Field.emptyAmount);
                        widget.type == Field.update
                            ? Method.edit(
                                context,
                                _btnController,
                                body,
                                Uri.parse(AdminAPI.updateLoanProduct.toString() + widget.loanProduct!.id.toString()),
                                Type.loanProduct,
                                LoanProductLayout(
                                  type: Field.create,
                                ),
