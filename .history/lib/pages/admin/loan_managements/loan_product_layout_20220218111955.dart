    ...
    return Scaffold(
      ...
      appBar: myAppBar(
          title: widget.type == Field.update
              ? Str.updateLoanProduct
              : Str.createLoanProduct,
          implyLeading: true,
          context: context),
      body: ListView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  NewField(
                    mandatory: true,
                    initialValue: widget.type == Field.update
                        ? widget.loanProduct?.term.toString()
                        : Field.empty,
                  ...
                  ToggleSwitch(
                    initialLabelIndex: int.parse(
                        widget.loanProduct?.status ?? Field.emptyAmount),
                    minWidth: 120,
                    cornerRadius: 7.0,
                  ...
                  Container(
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: () {
                        status ??= int.parse(
                            widget.loanProduct?.status ?? Field.emptyInt);
                        ...
                        widget.type == Field.update
                            ? Method.edit(
                                ...
                                body,
                                Uri.parse(
                                    AdminAPI.updateLoanProduct.toString() +
                                        widget.loanProduct!.id.toString()),
                                Type.loanProduct,
                                LoanProductLayout(
                                  type: Field.create,
                                ),
