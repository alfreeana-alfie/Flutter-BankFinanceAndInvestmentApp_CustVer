              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      _horizontalSlider(Str.sendMoneyListTxt, RouteSTR.sendMoneyList),
                      const Gap(10),
                      _horizontalSlider(
                          Str.exchangeMoneyListTxt, RouteSTR.exchangeMoneyList),
                      const Gap(10),
                      _horizontalSlider(
                          Str.wireTransferListTxt, RouteSTR.wireTransferList),
                      const Gap(10),
                      _horizontalSlider(
                          Str.userListTxt, RouteSTR.usersList),
                      const Gap(10),
                      _horizontalSlider(Str.supportTicketListTxt, RouteSTR.supportTicketListTxt),
                      const Gap(10),
