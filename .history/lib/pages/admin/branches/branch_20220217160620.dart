...
class BranchEditable extends StatefulWidget {
  const BranchEditable({Key? key, this.branch, this.type}) : super(key: key);

  final Branch? branch;
  final String? type;

  @override
  _BranchEditableState createState() => _BranchEditableState();
}

class _BranchEditableState extends State<BranchEditable> {
