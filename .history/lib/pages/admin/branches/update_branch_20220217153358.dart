...
class UpdateBranch extends StatefulWidget {
  const UpdateBranch({Key? key, required this.branch, this.type})
      : super(key: key);
...
class _UpdateBranchState extends State<UpdateBranch> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: myAppBar(
          title: widget.type == Field.update ? Str.updateBranch : Str.createBranch, 
          implyLeading: true, 
          context: context
      ),
      body: ListView(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  NewField(
                      initialValue: widget.type == Field.update ? widget.branch.name : Field.empty,
                  ...
                  const Gap(20.0),
                  NewField(
                    initialValue: widget.type == Field.update ? widget.branch.contactEmail : Field.empty,
                  ...
                  const Gap(20.0),
                  NewField(
                    initialValue: widget.type == Field.update ? widget.branch.contactPhone : Field.empty,
