...
class PaymentMethodWalletMenu extends StatefulWidget {
  ...
  final String? method,
      ...
      pageName,
      type,
      userId, currencyId, currencyName;
...
class _PaymentMethodWalletMenuState extends State<PaymentMethodWalletMenu> {
  ...
  void sendData(
    ...
    Map<String, String> body = {
      ...
      Field.transactionCode: Field.transactionCode + 'NGN-' + getRandomString(6),
    };
    ...
    Map<String, String> toUserBody = {
      ...
      Field.currencyId: widget.currencyId ?? 'NGN',
      Field.transactionCode: Field.transactionCode + '${widget.currencyName}-' + getRandomString(6),
    };
          ...
          Container(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  // //** CASH DEPOSIT
                  // widget.user!.userType!.contains(Field.accountant) ?
                  // Container(
  ...
  Future<void> makePayment() async {
    ...
    try {
      paymentIntentData = await createPaymentIntent(widget.amount, 'ngn');
