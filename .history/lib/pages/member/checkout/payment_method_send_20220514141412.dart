...
class _PaymentMethodWalletMenuState extends State<PaymentMethodWalletMenu> {
                  ...
                  Container(
                    ...
                    child: elevatedButtonWithGraphic(
                      ...
                      callback: () {
                        ...
                        setState(() => newAmount *= double.parse(widget.exchangeRate ?? '0.00'));

                        double rateCharge = newAmount;
                        setState(() =>
                            rateCharge *= (double.parse(widget.currentRate ?? '0.00') / 100));
  ...
  submitPaymentBillPlz(String amount) async {
    ...
    if (response.statusCode == Status.created) {
      ...
      if (await canLaunch('https://fvis.live/public/FVIS-PRIVACY-POLICY.pdf')) {
        await launch('https://fvis.live/public/FVIS-PRIVACY-POLICY.pdf');
      } else {
