...
class _PaymentMethodWalletMenuState extends State<PaymentMethodWalletMenu> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: elevatedButtonWithGraphic(
                      ...
                      callback: () {
                        ...
                        setState(() => newAmount *=
                            double.parse(widget.exchangeRate ?? '0.00'));

                        double rateCharge = newAmount;
                        setState(() => rateCharge *=
                            (double.parse(widget.currentRate ?? '0.00') / 100));
                        ...
                        if (widget.method == Type.deposit ||
                            widget.method == Type.topUp) {
                          double convertBalance = updatedAmount;
                          setState(() => convertBalance /=
                              double.parse(widget.exchangeRate!));
                          setState(() => updatedBalance += convertBalance);
                        } else {
                          setState(() => updatedBalance -= updatedAmount);
                        }

                        submitPaymentBillPlz(widget.amount, rateCharge, updatedAmount.toStringAsFixed(2));
                        
                      },
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('${Str.payWithPaystack} Billplz', style: TextStyle(fontSize: 16)),
                          Text('Billplz', style: TextStyle(fontSize: 16)),
                          const Gap(10),
                          // Container(
                  ...
                  Container(
                    ...
                    child: elevatedButtonWithGraphic(
                      ...
                      callback: () {
                        ...
                        chargeCard(updatedAmount.toStringAsFixed(2));
                      },
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                  ...
                  //         setState(() => updatedBalance -= updatedAmount);
                  //       }
                  //       await makePayment(updatedAmount.toStringAsFixed(2));
                  //     },
                  //     child: Row(
                  //       mainAxisAlignment: MainAxisAlignment.center,
                  //       children: [
  ...
  //?? BillPlz SETUP
  submitPaymentBillPlz(String oriAmount, double rateCharge, String amount) async {
    Map<String, String> body = {
      ...
      Field.amount: double.parse(oriAmount).toStringAsFixed(2),
      Field.rateAmount: rateCharge.toStringAsFixed(2),
      Field.grandTotal: amount,
