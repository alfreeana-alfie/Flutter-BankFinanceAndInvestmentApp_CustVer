        ...
        child: elevatedButton(
          ...
          callback: () {
            Map<String, String> body = {
              ...
              Field.otherBankId: email, 
              Field.gatewayId: email,
              Field.createdUserId: email, 
              Field.updatedUserId: email, 
              Field.branchId: email, 
              Field.transactionsDetails: email
            };
