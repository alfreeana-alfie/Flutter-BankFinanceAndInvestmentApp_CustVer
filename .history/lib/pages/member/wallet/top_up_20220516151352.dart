...
import 'package:flutter_banking_app/pages/member/checkout/payment_method_send.dart'  if(dart.library.html) 'package:flutter_banking_app/pages/member/checkout/payment_method_send_web.dart';
...
class MTopUpWallet extends StatefulWidget {
  final String? walletId, accountId, walletBalance;

  const MTopUpWallet(
      {Key? key, this.walletId, this.accountId, this.walletBalance})
      : super(key: key);

  @override
  _MTopUpWalletState createState() => _MTopUpWalletState();
}

class _MTopUpWalletState extends State<MTopUpWallet> {
