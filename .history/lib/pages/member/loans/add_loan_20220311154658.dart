                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (fileNationalIdentityCard != null) fileDetails(fileNationalIdentityCard!),
                      const Gap(20.0),
                      // ** Bank Statement
                      const Padding(
                        padding: EdgeInsets.fromLTRB(7, 0, 0, 2),
                        child: Text(Str.bankStatement,
                            style: Styles.primaryTitle),
                      ),
                      ElevatedButton(
                        onPressed: () async {
                      ...
                      if (fileBankStatement != null) fileDetails(fileBankStatement!),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: elevatedButton(
                    ...
                    callback: () {
                      Map<String, String> body = {
                        ...
                        Field.nationalIdentityCard: fileNationalIdentityCard!.name,
                      ...
                      LoanRequestMethods.add(context, body, file!.path ?? file!.name, file!.path ?? file!.name, file!.path ?? file!.name);
                    },
                    text: Str.submit,
                  ),
                ),
