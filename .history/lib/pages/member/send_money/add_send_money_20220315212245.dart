                      ...
                      callback: () {
                        if (accountBalance != '0.00') {
                          ...
                          double newAmount = double.parse(amount!);
                            ...
                            double updatedBalanceReceiver = double.parse(accountBalance!)
                            setState(() => updatedBalanceReceiver += updatedAmount);
                          ...
                          Map<String, String> bodySender = {
                            ...
                            Field.currentRate: currentRate.toString() ?? '0',
                          ...
                          WalletMethods.update(context, updateWalletBodySender,
                              walletId ?? '0');
