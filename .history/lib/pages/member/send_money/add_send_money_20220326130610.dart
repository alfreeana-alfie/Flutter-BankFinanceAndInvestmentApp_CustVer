            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Padding(
                        ...
                        child:
                            Text(Str.from, style: Styles.primaryTitle),
                      ),
                      const Padding(
                  ...
                  Row(
                    children: [
                      Padding(
                        padding: const EdgeInsets.fromLTRB(7, 0, 0, 10),
                        child:
                            Text(Str.to, style: Styles.primaryTitle),
                      ),
                      const Padding(
                        padding: EdgeInsets.fromLTRB(7, 0, 0, 10),
                        child: Text(
                  ...
                  const Gap(20), = val.accountId.toString();
                            accountName = val.description ?? 'DEFAULT';
                            Row(
                    children: [
                      Padding(
