...
class UpdateWallet extends StatefulWidget {
  ...
  final String? customerId, customerName, customerEmail, customerPhone, walletId, accountId, walletBalance, type;
      ...
      body: ListView(
        ...
        children: [
          ...
          elevatedButton(
            ...
            context: context,
            callback: () {
              String? transactionCode = Field.transactionCodeInitials +
                  '$currencyName-' +
                  getRandomCode(6);
              ...
              emailMessage =
                  'Deposited $currencyName ${double.parse(amount!).toStringAsFixed(2)} into your SAVINGS account.';
              emailMessage01 =
              ...
              Map<String, String> bodySender = {
                Field.userId: widget.customerId ?? '0',
              ...
              WalletMethods.update(
                  context, updateWalletBodySender, widget.walletId ?? '0');

              if (userLoad.emailVerifiedAt != null) {
                EmailJS.send(
                    context,
                    widget.customerEmail ?? 'customer@gmail.com',
                    widget.customerName ?? 'user',
                    'FVIS Investment',
                ...
                SMSNigeriaAPI.send(context, widget.customerPhone ?? '000',
                    'Deposited $currencyName ${double.parse(amount!).toStringAsFixed(2)} into your SAVINGS account. FVIS Investment ');
              }
