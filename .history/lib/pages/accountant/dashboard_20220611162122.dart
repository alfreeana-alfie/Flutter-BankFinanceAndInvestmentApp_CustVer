...
class _AccountDashboardState extends State<AccountDashboard> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      _horizontalSlider(Str.customerList),
                      const Gap(10),
                      _horizontalSliderAdd(Str.registerNewClient),
                    ],
                  ),
                ),
                const Gap(20),
                ...
                TransactionTodayListAccountant(userLoad: userLoad)
              ],
            );
          }
        }
  ...
  _horizontalSlider(String title) {
  ...
  _horizontalSliderAdd(String title) {
    return ElevatedButton(
      onPressed: () {
        Navigator.of(context).push(
          MaterialPageRoute(
