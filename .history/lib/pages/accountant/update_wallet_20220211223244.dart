...
import 'package:flutter_banking_app/widgets/dropdown/dropdrown_user_wallet.dart';
...
class UpdateWallet extends StatefulWidget {
  ...
  final String? customerId, walletId, accountId, walletBalance;
...
class _UpdateWalletState extends State<UpdateWallet> {
  ...
  String? currentMembershipId, currentMembershipName, walletId, accountId, walletBalance;
          ...
          Row(
            children: [
              Padding(
                ...
                child: Text(Str.userAccount, style: Styles.primaryTitle),
              ),
              const Padding(
