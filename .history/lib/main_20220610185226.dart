...
import 'package:flutter_banking_app/pages/failed.dart' if(dart.library.html) 'package:flutter_banking_app/pages/failed_web.dart';
import 'package:flutter_banking_app/pages/success.dart' if(dart.library.html) 'package:flutter_banking_app/pages/success_web.dart';
...
import 'pages/member/wallet/wallet.dart';
    ...
    OKToast(
      child: MaterialApp(
        ...
        routes: {
          ...
          RouteSTR.profile: (context) => const Profile(),

          RouteSTR.success: (context) => const SuccessPage(),
          RouteSTR.failed: (context) => const FailedPage(),
          ...
          RouteSTR.walletListM: (context) => const WalletPage(),
          ...
          RouteSTR.assignRole: (context) => const AssignRole(),dart fix --apply
