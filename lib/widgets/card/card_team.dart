    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            DetailRow(labelTitle: Str.nameTxt, labelDetails: team.name ?? Field.emptyString),
            DetailRow(
                labelTitle: Str.imageTxt, labelDetails: team.image ?? Field.emptyString),
            DetailRow(labelTitle: Str.roleTxt, labelDetails: team.role ?? Field.emptyString),
