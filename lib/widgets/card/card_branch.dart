    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            DetailRow(labelTitle: Str.nameTxt, labelDetails: branch.name ?? Field.emptyString),
            DetailRow(labelTitle: Str.contactEmailTxt, labelDetails: branch.contactEmail ?? Field.emptyString),
            DetailRow(labelTitle: Str.contactPhoneTxt, labelDetails: branch.contactPhone ?? Field.emptyString),
            DetailRow(labelTitle: Str.addressTxt, labelDetails: branch.address ?? Field.emptyString),
            DetailRow(labelTitle: Str.descriptionsTxt, labelDetails: branch.descriptions ?? Field.emptyString),
