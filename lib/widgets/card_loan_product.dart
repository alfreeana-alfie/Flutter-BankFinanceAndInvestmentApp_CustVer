    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            DetailRow(labelTitle: Str.nameTxt, labelDetails: product.name),
            DetailRow(labelTitle: Str.minAmtTxt, labelDetails: product.minAmt),
            DetailRow(labelTitle: Str.maxAmtTxt, labelDetails: product.maxAmt),
            DetailRow(labelTitle: Str.descriptionTxt, labelDetails: product.description),
            DetailRow(labelTitle: Str.interestRateTxt, labelDetails: product.interestRate),
            DetailRow(labelTitle: Str.interestTypeTxt, labelDetails: product.interestType),
            DetailRow(labelTitle: Str.termTxt, labelDetails: product.term.toString()),
            DetailRow(labelTitle: Str.termPeriodTxt, labelDetails: product.termPeriod),
