...
class PaymentMethodWalletMenu extends StatefulWidget {
  ...
  final String? walletId, amount, accountId, walletBalance;
  @override
...
class _PaymentMethodWalletMenuState extends State<PaymentMethodWalletMenu> {
  ...
  String? amount, userId = '3', userName;
                    ...
                    Container(
                      ...
                      child: elevatedButton(
                        ...
                        callback: () {
                          ...
                          setState(
                              () => updatedBalance -= double.parse(widget.amount ?? '0.00'));
                          ...
                          WalletMethods.update(context, updateWalletBody, userId ?? '0');
                        },
  ...
  chargeCard() async {
    ...
    Charge charge = Charge()
      ..amount = int.parse(widget.amount ?? '10000') * 100
  ...
  Future<void> makePayment() async {
    ...
    try {
      paymentIntentData =
          await createPaymentIntent(widget.amount ?? '10000', 'NGN');
