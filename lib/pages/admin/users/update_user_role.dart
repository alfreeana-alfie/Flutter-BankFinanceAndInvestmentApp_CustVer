...
class UpdateUserRole extends StatefulWidget {
  const UpdateUserRole({Key? key, required this.role}) : super(key: key);

  final UserRole role;

  @override
  _UpdateUserRoleState createState() => _UpdateUserRoleState();
}

class _UpdateUserRoleState extends State<UpdateUserRole> {
