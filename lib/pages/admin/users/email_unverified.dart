...
class UnVerifiedEmail extends StatefulWidget {
  const UnVerifiedEmail({Key? key}) : super(key: key);

  @override
  _UnVerifiedEmailState createState() => _UnVerifiedEmailState();
}

class _UnVerifiedEmailState extends State<UnVerifiedEmail> {
