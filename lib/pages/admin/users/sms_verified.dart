...
class VerifiedSMS extends StatefulWidget {
  const VerifiedSMS({Key? key}) : super(key: key);

  @override
  _VerifiedSMSState createState() => _VerifiedSMSState();
}

class _VerifiedSMSState extends State<VerifiedSMS> {
