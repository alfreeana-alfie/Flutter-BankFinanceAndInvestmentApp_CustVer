...
class UpdateNavigation extends StatefulWidget {
  const UpdateNavigation({Key? key, required this.navigation})
      : super(key: key);

  final Navigation navigation;

  @override
  _UpdateNavigationState createState() => _UpdateNavigationState();
}

class _UpdateNavigationState extends State<UpdateNavigation> {
