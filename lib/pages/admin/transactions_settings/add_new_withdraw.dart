...
class AddNewWithdraw extends StatefulWidget {
  const AddNewWithdraw({Key? key}) : super(key: key);

  @override
  _AddNewWithdrawState createState() => _AddNewWithdrawState();
}

class _AddNewWithdrawState extends State<AddNewWithdraw> {
