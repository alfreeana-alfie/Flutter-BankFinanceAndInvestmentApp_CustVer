...
class ExchangeMoneyList extends StatefulWidget {
  const ExchangeMoneyList({Key? key}) : super(key: key);

  @override
  _ExchangeMoneyListState createState() => _ExchangeMoneyListState();
}

class _ExchangeMoneyListState extends State<ExchangeMoneyList> {
  ...
  Future view() async {
    final response =
        await http.get(AdminAPI.listOfExchangeMoney, headers: headers);
                ...
                child: ListView(
                  ...
                  children: [
                    for (Transaction trans in transList)
                      CardTransaction(transaction: trans),
                  ],
                ),
              ),
            );
