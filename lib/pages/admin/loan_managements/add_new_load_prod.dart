...
class AddNewLoanProduct extends StatefulWidget {
  const AddNewLoanProduct({Key? key}) : super(key: key);

  @override
  _AddNewLoanProductState createState() => _AddNewLoanProductState();
}

class _AddNewLoanProductState extends State<AddNewLoanProduct> {
