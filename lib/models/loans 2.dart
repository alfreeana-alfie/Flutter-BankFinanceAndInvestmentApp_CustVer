...
class Loan {
  ...
  String? borrowerId, approvedUserId, createdUserId, branchId, status,loanId,
      ...
      approvedDate,
      createdAt,
      transactionCode, currency, loanProduct;
  ...
  Loan(
      ...
      this.branchId,
      this.createdAt,
      this.transactionCode, this.currency, this.loanProduct});
  ...
  factory Loan.fromMap(Map<String, dynamic> map) {
    return Loan(
      ...
      nationalIdentityCard: map[Field.nationalIdentityCard] as String?,
      bankStatement: map[Field.bankStatement] as String?,
      ...
      loanProduct: map[Field.loanProduct] as String?,
    );
  }
}
